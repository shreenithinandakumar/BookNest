...
const AddBook  = () => {
        ...
        try{
            if(
                ...
                const response = await axios.post(
                    "https://booknest-c5hx.onrender.com/api/v1/add-book",
                    Data,
                    {headers}
                )
                setData({
    ...
    return (
        <div className='h-[100%] p-0 md:p-4'>
            <h1 className='ml-5 text-3xl md:text-4xl font-semibold text-yellow-50 mb-2'>Add Book</h1>
            <div className='p-4 big-zinc-800 rounded'>
                <div>
                    <label htmlFor="" className='text-zinc-400'>Image</label>
                    <input 
                        type="text"
                        className='w-full mt-2 bg-zinc-800 p-2 outline-none'
